...
import academy.devdojo.maratonajava.javacore.datas.execessoes.DataHoraInvalida06;
...
public abstract class EventoBase06 implements Agendavel06{
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase06(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
    ...
    public void exibirInfo() {
        ...
        System.out.println("Descrição evento:"+getDescricaoFormatada());
