...
import academy.devdojo.maratonajava.javacore.datas.execessoes.DataHoraInvalida07;
...
public abstract class EventoBase07 implements Agendavel07 {
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase07(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
