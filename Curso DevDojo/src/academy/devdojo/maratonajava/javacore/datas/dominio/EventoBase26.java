...
import academy.devdojo.maratonajava.javacore.datas.execessoes.DataHoraInvalida26;
...
public abstract class EventoBase26 implements Agendavel26{
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase26(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
