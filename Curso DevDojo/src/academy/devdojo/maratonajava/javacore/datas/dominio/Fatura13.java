...
public class Fatura13 {
    private String numero;
    private double valor;
    private LocalDate vencimento;
    private LocalDateTime dataHoraCadastro;

    public Fatura13(String numero, double valor, LocalDate vencimento) {
        setNumero(numero);
        setValor(valor);
    ...
    public void setVencimento(LocalDate vencimento) {
        ...
        this.vencimento = Feriados13.ajustarParaProximoDiaUtil(vencimento);
    }
