...
public class Pessoa10 {
    ...
    public Pessoa10(String nome, int idade, String cpf) {
        setNome(nome);
        setIdade(idade);
        setCpf(cpf);
    }
    ...
    public static final String MENSAGEM_ERRO_CPF = "Campo CPF não pode ser vazio ou conter caracteres.";
    public static final String MENSAGEM_ERR0_IDADE = "Campo idade não pode ser vazio ou conter caracteres.";
    ...
    public void validacaoIdade(int idade){
        if (idade < IDADE_MINIMA){
            throw new IllegalArgumentException(MENSAGEM_ERR0_IDADE);
        }
    }
