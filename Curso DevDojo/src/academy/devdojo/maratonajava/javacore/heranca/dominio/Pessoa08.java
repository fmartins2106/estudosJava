...
public class Pessoa08 {
    private String nome;
    private int idade;
    private String cpf;

    public Pessoa08(String nome, int idade, String cpf) {
        setNome(nome);
        setIdade(idade);
        setCpf(cpf);
    }
    ...
    public static final String MENSAGEM_ERRO_IDADE_MINIMA = "Idade não pode ser inferior a 6.";
