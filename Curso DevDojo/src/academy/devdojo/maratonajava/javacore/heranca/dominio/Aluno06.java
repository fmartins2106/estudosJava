...
public class Aluno06 extends Pessoa06{
    private int matricula;
    private double[] notas = new double[4];
    private double media;

    public Aluno06(String nome, int idade, String cpf, int matricula, double[] notas) {
    ...
    public static final String MENSAGEM_ERRO_MATRICULA = "Matricula não pode ser menor que zero.";
