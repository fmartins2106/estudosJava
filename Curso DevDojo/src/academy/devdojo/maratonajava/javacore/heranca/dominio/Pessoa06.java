...
public class Pessoa06 {
    ...
    public Pessoa06(String nome, int idade, String cpf) {
        setNome(nome);
        setIdade(idade);
        setCpf(cpf);
    }

    public static final String MENSAGEM_ERRO_NOME = "Campo nome não pode conter ser vazio ou conter caracteres. Digite nome completo.";
    public static final int IDADE_MINIMA = 6;
    public static final String MENSAGEM_ERRO_IDADE_MINIMA = "Idade não pode ser menor que 6.";
