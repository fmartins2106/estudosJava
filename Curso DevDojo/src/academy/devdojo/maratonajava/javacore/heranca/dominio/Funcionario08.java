...
public class Funcionario08 {
    private String nome;
    private String departamento;
    private int idade;

    public Funcionario08(String nome, String departamento, int idade) {
        setNome(nome);
    ...
    public void setDepartamento(String departamento) {
        ...
        this.departamento = formatoNomes(departamento);
    ...
    public String toString(){
        return String.format("Nome:"+nome+" |Departamento: "+departamento+" |Idade: "+idade);
    }
}
