...
public class Produto15 {
    ...
    public Produto15(int codigo, String nome, String categoria, double valor, int quantidade, int estoqueMinimo){
        setCodigo(codigo);
        setNome(nome);
    ...
    public void setQuantidade(int quantidade) {
        if (quantidade < 0){
            throw new IllegalArgumentException("Quantidade não pode ser menor zero.");
        }
    ...
    public void setEstoqueMinimo(int estoqueMinimo) {
        if (estoqueMinimo < 50 ){
            throw new IllegalArgumentException("Estoque mínimo não pode ser menor que 50 unidades.");
        }
    ...
    public boolean validandoEstoqueBaixo(){
