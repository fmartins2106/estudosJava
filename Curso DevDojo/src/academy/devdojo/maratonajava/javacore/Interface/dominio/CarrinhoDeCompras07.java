...
public class CarrinhoDeCompras07 {
    private List<Vendavel07> produtos = new ArrayList<>();
    private List<Integer> quantidades = new ArrayList<>();

    public void addCarrinho(Produto07 produto07, int quantidade){
        if (produto07.reduzirEstoque(quantidade)){
            produtos.add(produto07);
    ...
    public void removerProdutoCarrinho(int index){
        if (index > 0 || index < produtos.size()){
            Produto07 produto07 = (Produto07) produtos.get(index);
            produto07.reduzirEstoque(-quantidades.get(index));
    ...
    public void exibirCarrinho(){
        ...
        for (int i = 0; i < produtos.size(); i++) {
            Vendavel07 produto = produtos.get(i);
