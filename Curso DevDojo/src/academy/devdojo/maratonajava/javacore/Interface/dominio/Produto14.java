...
public class Produto14 implements Vendavel14{
    private String nome;
    private double preco;
    private int estoque;

    public Produto14(String nome, double preco, int estoque) {
        setNome(nome);
        setPreco(preco);
        setEstoque(estoque);
    }
    ...
    public static void validacaoNome(String nome){
        if (nome == null || nome.isEmpty() || !nome.matches("^[\\p{L}0-9]+( [\\p{L}0-9]+)*$")){
            throw new IllegalArgumentException(MensagensValidacaoProduto14.NOME.getDescricao());
        }
    }
    ...
    public static void validacaoPreco(double preco){
        if (preco < MENOR_PRECO){
            throw new IllegalArgumentException(MensagensValidacaoProduto14.PRECO.getDescricaoFormatada(MENOR_PRECO));
        }
    }
    ...
    public static void validacaoEstoque(int estoque){
        if (estoque < MENOR_ESTOQUE){
            throw new IllegalArgumentException(MensagensValidacaoProduto14.ESTOQUE.getDescricaoFormatada(MENOR_ESTOQUE));
        }
    }
    ...
    public enum MensagensValidacaoProduto14{
        ...
        MensagensValidacaoProduto14(String descricao) {
