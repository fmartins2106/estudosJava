...
public class SistemaProdutosComMap02 {
    ...
    private boolean removerProdutoSistema(String nome){
    ...
    private void quantidadeTotalEstoque(){
    ...
    private double valorTotalEstoque(){
        return produto05Map.values().stream().mapToDouble(e -> e.getQuantidade() * e.getPreco()).sum();
    }

    public DadosProduto05 buscarPorNome(String nome){
