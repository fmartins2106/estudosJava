...
public class Fatura26 {
    private String numero;
    private double valor;
    private LocalDate vencimento;
    private LocalDateTime dataHoraCadastro;

    public Fatura26(String numero, double valor, LocalDate vencimento) {
        setNumero(numero);
        setValor(valor);
