...
public class ValidadorDeEntradasFatura12 {
    ...
    public static String validandoNumeroFatura(){
        while (true){
            try {
                ...
                Fatura12.validacaoNumeroFatura(numero);
                return numero;
            }catch (NumeroFaturaException12 e){
    ...
    public static double validandoValor(){
        while (true){
            try {
                ...
                Fatura12.validacaoValorFatura(valor);
                return valor;
            }catch (ValorFaturaException12 e){
                System.out.println(e.getMessage());
    ...
    public static LocalDate validandoVencimento(){
        ...
        while (true){
            try {
                ...
                Fatura12.validacaoDataVencimento(vencimento);
                return vencimento;
            }catch (DateTimeException e){
                System.out.println("Erro. Data inválida.");
            }catch (DataVencimentoFaturaException12 e){
                System.out.println(e.getMessage());
            }
        }
    }
