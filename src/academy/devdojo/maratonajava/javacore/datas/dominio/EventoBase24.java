...
import academy.devdojo.maratonajava.javacore.datas.execessoes.DataHoraInvalida24;
...
public abstract class EventoBase24 implements Agendavel24{
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase24(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
