...
import academy.devdojo.maratonajava.javacore.datas.execessoes.DataHoraInvalida21;
...
public abstract class EventoBase21 implements Agendavel21{
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase21(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
        setNomeEnvento(nomeEvento);
    ...
    public static void validacaoDataHora(ZonedDateTime dataHora){
        if (dataHora == null || dataHora.isBefore(ZonedDateTime.now(ZoneId.of("America/Sao_Paulo")))){
            throw new DataHoraInvalida21();
        }
    }

    public void setNomeEnvento(String nomeEvento) {
