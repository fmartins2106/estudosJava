...
import academy.devdojo.maratonajava.javacore.datas.execessoes.NomeEventoBase31;
...
public abstract class EventoBase31 implements Agendavel31{
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase31(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
    ...
    public static void validacaoDataVencimento(ZonedDateTime dataHora){
    ...
    public void setDataHora(ZonedDateTime dataHora) {
        validacaoDataVencimento(dataHora);
