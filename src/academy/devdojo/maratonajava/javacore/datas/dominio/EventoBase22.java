...
import academy.devdojo.maratonajava.javacore.datas.execessoes.DataHoraInvalida22;
...
public abstract class EventoBase22 implements Agendavel22{
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase22(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
