...
public class Fatura28 {
    private String numero;
    private double valor;
    private LocalDate vencimento;
    private LocalDateTime dataHoraCadastro;

    public Fatura28(String numero, double valor, LocalDate vencimento) {
        setNumero(numero);
        setValor(valor);
    ...
    public void exibirResumoFatura(ResourceBundle bundle, double multa){
        ...
        ,dataHoraCadastro.format(DateTimeFormatter.ofPattern("dd/MM/yyyy MM:hh"))));
        System.out.println("_____________________________________________________________________________________");
    }
