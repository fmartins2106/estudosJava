...
import academy.devdojo.maratonajava.javacore.datas.execessoes.DataHoraInvalida28;
...
public abstract class EventoBase28 implements Agendavel28{
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase28(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
    ...
    public void reagendar(int dias) {
        ...
        if (novaDataHora.isBefore(ZonedDateTime.now(ZoneId.of("America/Sao_Paulo")))){
            System.out.println("Operação negada. Data inválida.");
            return;
        }
        setDataHora(novaDataHora);
        System.out.println("Dados reagendando com sucesso.");
    }
