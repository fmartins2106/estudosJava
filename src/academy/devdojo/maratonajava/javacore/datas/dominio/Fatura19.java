...
public class Fatura19 {
    private String numero;
    private double valor;
    private LocalDate vencimento;
    private LocalDateTime dataHoraCadastro;

    public Fatura19(String numero, double valor, LocalDate vencimento) {
        setNumero(numero);
        setValor(valor);
    ...
    public void setVencimento(LocalDate vencimento) {
        ...
        this.vencimento = Feriados19.ajustarProximoDiaUtil(vencimento);
    }
    ...
    public Period getTotalPeriodoAtraso(){
    ...
    public void exibirDadosFatura(ResourceBundle bundle, double multa){
        Period p = getTotalPeriodoAtraso();
