...
public class Fatura09 {
    private String numero;
    private double valor;
    private LocalDate vencimento;
    private LocalDateTime dataHoraCadastro;

    public Fatura09(String numero, double valor, LocalDate vencimento) {
        setNumero(numero);
        setValor(valor);
    ...
    public void setVencimento(LocalDate vencimento) {
        ...
        this.vencimento = Feriados09.ajudarParaProximoDiaUtil(vencimento);
    }
    ...
    public void exibirResumo(ResourceBundle bundle, double multa){
        ...
        System.out.println(MessageFormat.format("{0} : R${1} ano(s), {2} mês(es), {3} dia(s)", bundle.getString("fatura.atraso")
        ,p.getYears(),p.getMonths(),p.getYears()));
