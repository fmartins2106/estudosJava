...
public abstract class EventoBase34 implements Agendavel34{
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase34(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
    ...
    public void reagendar(int dias) {
        ...
        try {
            ...
            System.out.println("Reagenda feita com sucesso.");
        }catch (DataHoraInvalida34 e){
