...
public class Fatura21 {
    private String numero;
    private double valor;
    private LocalDate vencimento;
    private LocalDateTime dataHoraCadastro;

    public Fatura21(String numero, double valor, LocalDate vencimento) {
        setNumero(numero);
        setValor(valor);
    ...
    public void setVencimento(LocalDate vencimento) {
        ...
        this.vencimento = Feriados21.ajudarProximoDiaUtil(vencimento);
    }
    ...
    public static LocalDate sugerirNovaDataVencimento(){
