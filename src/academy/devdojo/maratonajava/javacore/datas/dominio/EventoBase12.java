...
import academy.devdojo.maratonajava.javacore.datas.execessoes.DataHoraInvalida12;
...
public abstract class EventoBase12 implements Agendavel12 {
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase12(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
