...
import academy.devdojo.maratonajava.javacore.datas.execessoes.DataHoraInvalida15;
...
public abstract class EventoBase15 implements Agendavel15{
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase15(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
    ...
    public void reagendar(int dias) {
        ...
        ZonedDateTime zonedDateTime = ZonedDateTime.of(dataHora,this.dataHora.getZone());
        setDataHora(zonedDateTime);
    }
