...
public abstract class EventoBase23 implements Agendavel23{
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase23(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
