...
public class Fatura15 {
    private String numero;
    private double valor;
    private LocalDate vencimento;
    private LocalDateTime dataHoraCadastro;

    public Fatura15(String numero, double valor, LocalDate vencimento) {
        setNumero(numero);
        setValor(valor);
    ...
    public static void validacaoValorFatura(double valor){
        if (valor < ValorFaturaException15.MENOR_VALOR_FATURA){
            throw new ValorFaturaException15();
        }
    }

    public static void validacaoVencimentoFatura(LocalDate vencimento){
        if (vencimento == null /*|| vencimento.isBefore(LocalDate.now())*/){
            throw new DataVencimentoFaturaException15();
        }
    }
    ...
    public void setVencimento(LocalDate vencimento) {
        ...
        this.vencimento = Feriados15.ajustarParaProximoDiaUtil(vencimento);
    }
    ...
    public Period getAtrasoComPerido(){
