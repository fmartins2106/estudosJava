...
import academy.devdojo.maratonajava.javacore.datas.execessoes.DataHoraInvalida11;
...
public abstract class EventoBase11 implements Agendavel11 {
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase11(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
    ...
    public String getDescricaoDataCompleta(){
    ...
    public void exibirInfo() {
        ...
        System.out.println("Data completa:"+getDescricaoDataCompleta());
