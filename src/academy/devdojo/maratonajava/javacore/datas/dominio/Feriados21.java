...
public class Feriados21 {
    ...
    public static boolean eDiaUtil(LocalDate ano){
        Set<LocalDate> feriados = gerarFeriados(ano.getYear());
        DayOfWeek diaSemana = ano.getDayOfWeek();
        return diaSemana != DayOfWeek.SATURDAY &&
                diaSemana != DayOfWeek.SUNDAY &&
                !feriados.contains(ano);
    }

    public static LocalDate ajudarProximoDiaUtil(LocalDate data){
        if (eDiaUtil(data)){
