...
import academy.devdojo.maratonajava.javacore.datas.execessoes.DataHoraInvalida20;
...
public abstract class EventoBase20 implements Agendavel20{
    protected String nomeEvento;
    protected String localEvento;
    protected ZonedDateTime dataHora;

    public EventoBase20(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
    ...
    public void exibirInfo() {
        ...
        System.out.println("Data completa:"+getDateCompleta());
