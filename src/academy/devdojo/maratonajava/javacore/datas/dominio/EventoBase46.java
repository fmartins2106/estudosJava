...
public class EventoBase46 implements Agendavel46, Comparable<EventoBase46>{
    ...
    public EventoBase46(String nomeEvento, String localEvento, ZonedDateTime dataHora) {
