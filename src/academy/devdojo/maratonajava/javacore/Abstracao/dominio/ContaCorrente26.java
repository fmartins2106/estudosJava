...
public class ContaCorrente26 extends Conta26{
    private static final double TAXA_SAQUE = 5;

    public ContaCorrente26(Cliente26 cliente26, int numeroConta, double saldo, TipoConta26 tipoConta26, StatusConta26 statusConta26) {
    ...
    public void sacar(double valor){
        if (statusConta26 == StatusConta26.ATIVA){
            if (valor + TAXA_SAQUE <= saldo){
                ...
                System.out.println(MensagensValidacaoConta26.SAQUE_REALIZADO.getDescricaoFormatada(valor,TAXA_SAQUE));
            }else {
