...
public class ListaProdutos06 {
    ...
    public static Map<Categoria03,List<ProdutoStream03>> agruparPorCategoria(List<ProdutoStream03> produto){
    ...
    public static Map<Categoria03,DoubleSummaryStatistics> mostrarEstatisticas(List<ProdutoStream03> produtos){
        return produtos.stream()
                .collect(Collectors.groupingBy(ProdutoStream03::getCategoria03
                ,Collectors.summarizingDouble(ProdutoStream03::getPreco)));
    }

    public static Map<Categoria03,Map<Promocao03,List<ProdutoStream03>>> agruparMetodoAuxiliar(List<ProdutoStream03> produtos){
        return produtos.stream()
                .collect(Collectors.groupingBy(ProdutoStream03::getCategoria03
                ,Collectors.groupingBy(ListaProdutos06::getPromocao)));
    }

    public static void main(String[] args) {
       agruparPorCategoria(produtosLoja).forEach((categoria03, produtoStream03s)
               -> {
           System.out.println("Categoria:"+categoria03+" |Produto:"+produtoStream03s);
       });
    }
