...
public class Produto08 {
    ...
    public Produto08(int codigo, String nome, String categoria, int quantidade, double precoCompra, double precoVenda, String fornecedor) {
        setCodigo(codigo);
        setNome(nome);
    ...
    private static final int QUANIDADE_MINIMA=0;
    public void setQuantidade(int quantidade) {
        if (quantidade < QUANIDADE_MINIMA){
