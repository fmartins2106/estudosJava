...
public class Produto02 {
    ...
    public Produto02(int codigo, String nome, String categoria, int quantidade, double precoCompra, double precoVenda, String fornecedor) {
        this.codigo = codigo;
        this.nome = nome;
    ...
    public void setPrecoVenda(double precoVenda) {
        validandoPrecoVenda(precoVenda);
        this.precoVenda = precoVenda;
    }
    ...
    private void validandoPrecoVenda(double precoVenda){
    ...
    public String toString(){
        return String.format("Código: %d |Nome: %s |Categoria: %s |Quantidade: %d |Preço compra: %.2f |Preço venda: %.2f |Fornecedor: %s",
