...
public class Pessoa03 {
    ...
    public Pessoa03(String nome, int idade, String cpf) {
        setNome(nome);
        setIdade(idade);
        setCpf(cpf);
    }
    ...
    public static final String MENSAGE_ERRO_CPF = "CPF inválido. tente novamente.";
    ...
    public void validacaoCpf(String cpf){
        if (cpf == null || cpf.length() !=11 || !cpf.matches("\\d{11}") || !isCpfValido(cpf)){
            throw new IllegalArgumentException(MENSAGE_ERRO_CPF);
        }
    }
