...
public class Professor04 extends Pessoa04{
    ...
    public Professor04(String nome, int idade, String cpf, String disciplina, double salario) {
    ...
    public static final String MENSAGEM_ERRO_SALARIO_PROF = "Salário de professor não pode ser menor que R$3.000";
