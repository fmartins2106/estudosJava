...
public class Pessoa05 {
    ...
    public Pessoa05(String nome, int idade, String cpf) {
        setNome(nome);
        setIdade(idade);
        setCpf(cpf);
    }
    ...
    public static final String MENSAGEM_ERRO_IDADE_MINIMA = "Idade mínima não pode de ser vazio ou conter caracteres.";
