...
public class Pessoa04 {
    ...
    public Pessoa04(String nome, int idade, String cpf) {
        setNome(nome);
        setIdade(idade);
        setCpf(cpf);
    }
    ...
    public static final String MENSAGEM_ERR0_IDADE_MINIMA = "Idade não pode ser menor que 6 anos.";
    ...
    private void validacaoIdadeMinima(int idade){
        if (idade < IDADE_MINIMA){
            throw new IllegalArgumentException(MENSAGEM_ERR0_IDADE_MINIMA);
        }
    }
