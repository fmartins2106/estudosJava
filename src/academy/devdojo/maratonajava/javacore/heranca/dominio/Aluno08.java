...
public class Aluno08 extends Pessoa08{
    private int matricula;
    private double[] notas = new double[4];
    private double media;

    public Aluno08(String nome, int idade, String cpf, int matricula, double[] notas) {
    ...
    public static final String MENSAGEM_ERRO_NOTA = "Campo nota não pode ser menor que zero ou maio que dez.";
