...
public class Aluno07 extends Pessoa07 {
    private int matricula;
    private double[] notas = new double[4];
    private double media;

    public Aluno07(String nome, int idade, String cpf, int matricula, double[] notas) {
    ...
    public static final String MENSAGEM_ERRO_NOTA = "Campo nota não pode ser menor que 0 ou maior que 10.";
