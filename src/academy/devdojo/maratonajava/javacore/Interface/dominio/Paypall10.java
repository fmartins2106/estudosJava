...
public class Paypall10 implements Pagamento10{
    private double saldoPaypall;
    private static final DecimalFormat df = new DecimalFormat("0.00");

    public Paypall10(double saldoPaypall) {
    ...
    public void processarPagamentos(double valor){
        if (verificarSaldo(valor)){
            ...
            System.out.println("Valor inválido. Digite um valor menor que saldo em conta.");
        }
    }
