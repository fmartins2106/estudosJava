...
import academy.devdojo.maratonajava.javacore.excessoes.DataValidadePerecivel33;

import java.time.LocalDate;
import java.time.format.DateTimeFormatter;

public class ProdutoPerecivel33 extends ProdutoBase33{
    private LocalDate dataValidade;

    public ProdutoPerecivel33(String nome, double preco, int quantidade, int estoqueMinimo, LocalDate dataValidade) {
    ...
    public static void validacaoDataValidade(LocalDate dataValidade){
        if (dataValidade == null /*|| dataValidade.isBefore(LocalDate.now())}*/){
            throw new DataValidadePerecivel33();
        }
    }
