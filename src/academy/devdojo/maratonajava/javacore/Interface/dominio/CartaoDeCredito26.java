...
public class CartaoDeCredito26 implements Pagamento26{
    private double limiteCartao;
    private static final DecimalFormat df = new DecimalFormat("0.00");

    public CartaoDeCredito26(double limiteCartao) {
    ...
    public void processarPagamentos(double valor){
        ...
        System.out.println("Pagamento não autorizado. Verifique o valor.");
    }
