...
public class DadosProduto03 {
    private String nome;
    private double preco;
    private int quantidade;
    private String descricao;

    public DadosProduto03(String nome, double preco, int quantidade, String descricao) {
        setNome(nome);
        setPreco(preco);
    ...
    public String toString() {
        return String.format("Produto:"+this.nome+" |Preço:R$"+this.preco+" |Quantidade:"+this.quantidade+" |Descricação:"+this.descricao);
    }
}
