...
import academy.devdojo.maratonajava.javacore.excessoes.DataValidadePerecivel21;

import java.time.LocalDate;
import java.time.format.DateTimeFormatter;

public class ProdutoPerecivel21 extends ProdutoBase21{
    private LocalDate dataValidade;

    public ProdutoPerecivel21(String nome, double preco, int quantidade, int estoqueMinimo, LocalDate dataValidade) {
    ...
    public static void validacaoDataValidade(LocalDate dataValidade){
        if (dataValidade == null /*|| dataValidade.isBefore(LocalDate.now())*/){
            throw new DataValidadePerecivel21();
        }
    }
