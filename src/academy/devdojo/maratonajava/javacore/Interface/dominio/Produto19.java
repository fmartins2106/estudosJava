...
public class Produto19 implements Vendavel19{
    private String nome;
    private double preco;
    private int estoque;

    public Produto19(String nome, double preco, int estoque) {
        setNome(nome);
        setPreco(preco);
        setEstoque(estoque);
    }
    ...
    public static void validacaoNome(String nome){
        if (nome == null || nome.isEmpty() || !nome.matches("^[\\p{L}0-9]+( [\\p{L}0-9]+)*$")){
            throw new IllegalArgumentException(MensagensValidacaoProduto19.NOME.getDescricao());
        }
    }
    ...
    public static void validacaoPreco(double preco){
        if (preco < MENOR_PRECO){
            throw new IllegalArgumentException(MensagensValidacaoProduto19.PRECO.getDescricaoFormatada(MENOR_PRECO));
        }
    }
    ...
    public static void validacaoEstoque(int estoque){
        if (estoque <  MENOR_ESTOQUE){
            throw new IllegalArgumentException(MensagensValidacaoProduto19.ESTOQUE.getDescricaoFormatada(MENOR_ESTOQUE));
        }
    }
    ...
    public enum MensagensValidacaoProduto19{
        ...
        MensagensValidacaoProduto19(String descricao) {
