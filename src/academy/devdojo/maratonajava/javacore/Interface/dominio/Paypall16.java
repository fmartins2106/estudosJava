...
public class Paypall16 implements Pagamento16{
    private double saldoPaypall;
    private static final DecimalFormat df = new DecimalFormat("0.00");

    public Paypall16(double saldoPaypall) {
    ...
    public void consultarSaldo(){
        System.out.println("Saldo atualizado no valor de R$"+df.format(saldoPaypall));
    }
