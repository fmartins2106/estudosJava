...
public class Produto18 {
    ...
    public Produto18(int codigo, String nome, String categoria, double valor, int quantidade, int estoqueMinimo){
        setCodigo(codigo);
        setNome(nome);
    ...
    public void setCategoria(String categoria) {
        if (categoria == null || categoria.isEmpty() || !categoria.matches("^[\\p{L}]+( [\\p{L}]+)*$")){
            throw new IllegalArgumentException("Campo categoria não pode ser vazio ou conter caractetes.");
        }
    ...
    public void setEstoqueMinimo(int estoqueMinimo) {
        if (estoqueMinimo < 50){
            throw new IllegalArgumentException("Estoque minimo não pode ser menor que 50.");
        }
