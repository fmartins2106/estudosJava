...
public class TreinoProdutorDePedidos04 implements Runnable{
    public final BlockingQueue<Pedido06> filaPedido;
    public final List<String> clientes = Arrays.asList("Maria","Pedro","Mariana","Fernando");
    public Random random = new Random();

    public TreinoProdutorDePedidos04(BlockingQueue<Pedido06> filaPedido) {
    ...
    public void run(){
        while (!Thread.currentThread().isInterrupted()){
            try {
                ...
                System.out.printf("Erro na execução"+e.getMessage());
