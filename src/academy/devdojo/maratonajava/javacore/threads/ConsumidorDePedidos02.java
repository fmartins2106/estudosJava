...
public class ConsumidorDePedidos02 implements Runnable{
    ...
    public ConsumidorDePedidos02(BlockingQueue<Pedido06> filaPedido, ExecutorService executor) {
        this.filaPedido = filaPedido;
        this.executor = executor;
    }

    public void run(){
        RelatorioDePedidos06 relatiorio = new RelatorioDePedidos06();
        while (!Thread.currentThread().isInterrupted()){
            try {
                ...
                System.out.println("Execussão intenrrompida"+e.getMessage());
            }
        }
    }
}
